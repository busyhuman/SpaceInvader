...
public static class EngToKor
{
    public static string Translate(string str)
    {
        string[] ENG = 
        {
            ...
            "{\"password1\":[\"This password is too short. It must contain at least 8 characters.\"],\"password2\":[\"This field may not be blank.\"]}",
            ...
            "{\"password1\":[\"This password is too common.\"],\"password2\":[\"This field may not be blank.\"]}",
            "{\"username\":[\"A user with that username already exists.\"],\"password2\":[\"This field may not be blank.\"]}",
            "{\"username\":[\"A user with that username already exists.\"],\"password1\":[\"This field may not be blank.\"]}",
            "{\"username\":[\"A user with that username already exists.\"],\"password1\":[\"This password is too short. It must contain at least 8 characters.\"],\"password2\":[\"This field may not be blank.\"]}",
            "{\"username\":[\"A user with that username already exists.\"],\"password1\":[\"This password is too common.\"],\"password2\":[\"This field may not be blank.\"]}",
            "{\"password1\":[\"This password is too short. It must contain at least 8 characters.\",\"This password is too common.\"],\"password2\":[\"This field may not be blank.\"]}",
            "{\"password1\":[\"This password is too short. It must contain at least 8 characters.\",\"This password is too common.\"]}",
            "{\"username\":[\"A user with that username already exists.\"],\"password1\":[\"This password is too short. It must contain at least 8 characters.\",\"This password is too common.\"],\"password2\":[\"This field may not be blank.\"]}",
            "{\"username\":[\"A user with that username already exists.\"],\"password1\":[\"This password is too short. It must contain at least 8 characters.\",\"This password is too common.\"]}",
